...
window.HeightmapTemplates = (function () {
  ...
  const terra = `Hill 1 100 60 50
    Hill 1 50 40 50
    Multiply 0.20 20-100 0 0
    Smooth 2 0 0 0
    Range 1 70 70 50
    Pit 32 2-4 35-65 30-70
    Range 1 100 30 35`;

  return {volcano, highIsland, lowIsland, continents, archipelago, atoll, mediterranean, peninsula, peninsula, pangea, isthmus, shattered, terra};
})();
