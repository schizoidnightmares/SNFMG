...
window.Lakes = (function () {
  ...
  function getGroup(feature) {
    if (feature.temp < 0) return "frozen";
    if (feature.temp > 35) return "hot";

    if (!feature.inlets && !feature.outlet) {
      if (feature.evaporation > feature.flux * 1.75) return "dry";
      if (feature.height > 20 && feature.cells < 10 && feature.firstCell % 4 === 0) return "lava";
      if (feature.cells < 10 && feature.firstCell % 3 === 0) return "sinkhole";
    }
